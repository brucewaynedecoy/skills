...
Verify all four independently. Source work does not authorize database initialization; initialization does not authorize workflow registration or a live heartbeat change.
